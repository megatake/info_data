            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        ...
                        <p class="mb-4">Unlocking Potential, Igniting Excellence</p> <a type="button" class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#applyLoan">See
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled">
                            <li class="list-inline-item me-4"><a class="text-black" href="{{ route('page', 4) }}" wire:navigate>Privacy Policy</a>
                            </li>
